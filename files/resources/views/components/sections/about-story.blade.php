@props([
    ...
    'bodyTwo' => 'I work end to end — strategy, identity, design, and the code that ships it. One person, no handoffs, no telephone game. You talk to the person making the thing, every time.',
    'image' => 'https://assets.ui.sh/avatars/7.webp?w=1000&h=750',
    'imageAlt' => 'Marlo at the studio desk',
